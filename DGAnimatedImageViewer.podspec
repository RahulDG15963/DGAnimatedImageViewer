...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of DGAnimatedImageViewer.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Rahul Dasgupta/DGAnimatedImageViewer'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Rahul Dasgupta' => 'rahul.dasgupta@innofied.com' }
  s.source           = { :git => 'https://github.com/Rahul Dasgupta/DGAnimatedImageViewer.git', :tag => s.version.to_s }
